...
public class MainActivity extends AppCompatActivity implements VideoDetectionManager.VideoDetectionListener {
        ...
        session.setNavigationDelegate(new GeckoSession.NavigationDelegate() {
            ...
            public GeckoResult<AllowOrDeny> onLoadRequest(
                ...
                runOnUiThread(() -> {
                    ...
                    // Save to history
                    String title = urlBar.getText().toString();
                    HistoryActivity.addToHistory(MainActivity.this, title, request.uri);
                });
    ...
    private void showBrowserMode(boolean animate) {
        ...
        bottomNav.animate()
                .translationY(0f).alpha(1f)
                .setDuration(350).setStartDelay(150)
                .setInterpolator(new DecelerateInterpolator()).start();
    ...
    public void onVideosCleared() {
        runOnUiThread(() -> { detectedVideos.clear(); updateVideoBadge(); });
    }
    ...
    private void updateVideoBadge() {
        if (detectedVideos.size() > 0) {
            ...
            if (detectedVideos.size() == 1) {
                Toast.makeText(this, "🎬 " + detectedVideos.size() + " video found!",
                        Toast.LENGTH_SHORT).show();
            }
        } else {
            videoBadge.animate()
    ...
    // ========================================================================
    //  MENU — Updated with new activities
    // ========================================================================
        ...
        menuBtn.setOnClickListener(v -> {
            ...
            popup.setOnMenuItemClickListener(item -> {
                ...
                if (id == R.id.menu_settings) {
                    ...
                    Toast.makeText(this, "🔍 Find in Page coming soon",
                            Toast.LENGTH_SHORT).show();
                    return true;
                    ...
                    if (proxyController.isProxyRunning()) {
                        ...
                        Toast.makeText(this, "🌐 Proxy started on port 8888",
                                Toast.LENGTH_SHORT).show();
                    }
                    return true;
                }
